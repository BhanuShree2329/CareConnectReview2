      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border">
        <div className="container mx-auto flex items-center justify-between h-16 px-4">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/ngos" className="text-sm text-muted-foreground hover:text-foreground transition-colors">NGO Directory</Link>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
              A comprehensive platform connecting elder individuals, caretakers, NGOs, and administrators with secure consent management and transparent care workflows.
            </p>
        ...
        <div className="container mx-auto max-w-6xl text-center">
          ...
          >
            {[
              ...
              { role: "elder", desc: "Manage consent, view care status, raise alerts", icon: Heart, gradient: "bg-destructive" },
